...
Gem::Specification.new do |s|
  ...
  s.version     = QuickSearchDatabaseFinderSearcher::VERSION
  s.authors     = ['UMD Libraries']
  s.email       = ['lib-ssdr@umd.edu']
  s.homepage    = 'https://www.lib.umd.edu/'
  s.summary     = 'Database Finder searcher for NCSU Quick Search'
  s.description = 'Database Finder searcher for NCSU Quick Search.'
